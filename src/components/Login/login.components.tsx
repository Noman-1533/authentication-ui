...
//     // Create a custom event to send form data back
...
//     // Dispatch the event using the passed function
//     dispatchEvent(event);
//   };
...
//                     placeholder={"Enter your "+item.fieldLabel.toLowerCase()}
//                     value={item.fieldLabel==='Password'?password:email}
